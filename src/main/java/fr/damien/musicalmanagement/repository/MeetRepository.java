...
public class MeetRepository {
    ...
    public static ObservableList<Meet> getMeetBySongGroupObservableList(int songId, int groupId) {
        ObservableList<Meet> meetSGObservableList = FXCollections.observableArrayList();

        String SQL_MEET_BY_SONG_GROUP = "CALL find_meet_by_song_group(" + songId + "," + groupId + ");";
        try {
